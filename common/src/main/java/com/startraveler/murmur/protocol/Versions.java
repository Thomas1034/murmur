...
public class Versions {
    ...
    ).apply(instance, V1Message::new));


    public static final CodecRegistry.CodecRegistryEntry<? extends Message<MessageBody>> VERSION_1 = ProtocolCodecRegistries.VERSIONS.register(V1_LOCATION,
            V1_CODEC
    );
